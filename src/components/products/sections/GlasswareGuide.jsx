...
export default function GlasswareGuide({ cards = [] }) {
  ...
  return (
    <section id="glassware" className="scroll-mt-16 border-b border-zinc-200 bg-white px-4 py-14 sm:px-6 lg:px-8 dark:border-zinc-800 dark:bg-zinc-950">
            ...
            return (
              <div
                ...
                className={`relative rounded-2xl border-2 p-5 text-left transition ${
                  standard ? 'border-[#BE0010] shadow-lg shadow-[#BE0010]/10 dark:bg-zinc-900' : 'border-zinc-200 bg-white hover:border-[#BE0010]/30 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900'
                }`}
              >
                {standard && (
                ...
                {c.best && (
                  <div className="flex items-start gap-2 rounded-lg bg-zinc-50 px-3 py-2.5 text-xs font-semibold text-black dark:bg-zinc-800 dark:text-zinc-100">
