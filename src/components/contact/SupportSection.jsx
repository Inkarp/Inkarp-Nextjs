    ...
    <section className="relative mx-auto flex w-[98%] flex-col justify-center px-4 py-8">
      ...
      <div className="relative mx-auto w-[98%] max-w-4xl space-y-6">
        <div
          ...
          data-reveal
        >
          <span className="font-maxot rounded-full border border-red/30 bg-parchment px-4 py-1 text-xs uppercase text-zinc-950 sm:text-sm dark:bg-zinc-900 dark:text-zinc-100">
            Contact Us
          </span>
          <h2 className="font-maxot text-3xl text-[#E63946]">
            For Support &amp; Enquiries
          </h2>
          <p className="text-base text-ink dark:text-zinc-400">
          ...
          {supportData.map((item) => {
            ...
            return (
              <article
                ...
                className="group relative overflow-hidden rounded-2xl border border-line-light bg-parchment shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_14px_40px_rgba(230,57,70,0.15)] dark:border-zinc-800 dark:bg-zinc-900"
                data-scroll-reveal="true"
                key={item.title}
              >
                <span
                  aria-hidden="true"
                  className="absolute inset-x-0 top-0 h-1.5 bg-gradient-to-r from-red to-[#E63946]"
                />

                <div className="flex flex-col items-center gap-3 p-6 pt-7 text-center">
                  <div className="inline-flex size-14 items-center justify-center rounded-full bg-gradient-to-br from-red to-[#E63946] text-parchment shadow-lg shadow-red/20 ring-4 ring-[#fff3f4] dark:ring-zinc-800">
                  ...
                  <ul className="mt-1 w-full space-y-2">
                    <li>
                      <a
                        ...
                        className="flex items-center gap-2.5 rounded-lg bg-[#fef2f2] px-3 py-2.5 text-left text-xs font-semibold text-ink-soft transition hover:bg-red hover:text-parchment dark:bg-zinc-800 dark:text-zinc-200"
                    ...
                    <li>
                      <a
                        ...
                        className="flex items-center gap-2.5 rounded-lg bg-[#f5f5f5] px-3 py-2.5 text-left text-xs font-semibold text-ink-soft transition hover:bg-red hover:text-parchment dark:bg-zinc-800/70 dark:text-zinc-200"
