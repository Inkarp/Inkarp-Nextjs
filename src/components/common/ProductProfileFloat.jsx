  ...
  return (
    <div className="fixed bottom-4 left-4 z-40 flex flex-col items-end gap-3 text-sm">
        ...
        <div className="w-[320px] rounded-[32px] border border-red bg-parchment p-5 shadow-2xl shadow-zinc-900/15">
          <div className="mb-4 flex items-start justify-between gap-4">
            <div>
              ...
              <h2 className="mt-1 font-maxot text-lg text-ink">
                Share your interests
              </h2>
            </div>
            <button
              aria-label="Close feedback form"
              className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-parchment-alt text-ink-soft transition hover:bg-zinc-200"
          ...
          <form className="space-y-3" onSubmit={handleSubmit}>
            <div className="space-y-2">
              ...
              <input
                className="w-full rounded-2xl border border-line-light bg-parchment-alt px-4 py-2 text-sm focus:border-red focus:outline-none focus:ring-2 focus:ring-red/20"
                name="name"
            ...
            <div className="space-y-2">
              ...
              <textarea
                className="min-h-[90px] w-full resize-none rounded-2xl border border-line-light bg-parchment-alt px-4 py-3 text-sm focus:border-red focus:outline-none focus:ring-2 focus:ring-red/20"
                name="message"
                onChange={handleChange}
            ...
            <button
              className={`inline-flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-red to-[#E63946] px-4 py-3 text-sm font-semibold text-parchment transition ${
      ...
      <button
        ...
        className="inline-flex min-h-[52px] min-w-[52px] items-center justify-center rounded-full border border-red bg-parchment p-3 text-red shadow-lg shadow-zinc-900/15 transition hover:bg-[#fdf2f2] gap-2"
