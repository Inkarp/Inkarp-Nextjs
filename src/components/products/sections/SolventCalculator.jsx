      ...
      <div className="relative mx-auto max-w-[1180px] w-full">
        ...
        <div className="relative mt-6 grid gap-5 lg:grid-cols-[1fr_1fr]">
          ...
          <div className="space-y-3">
            ...
            <LeadCaptureForm
              className="w-full"
              formType="solvent-calculator"
              productName={productName}
              successMessage={(name) =>
                `Thank you${name ? `, ${name}` : ''}. We have sent your solvent recovery estimate to our team.`
              }
              summary={calculatorSummary}
              triggerLabel={calculatorData?.ctaLabel || 'Email this estimate to Inkarp'}
            />
          </div>
        </div>
