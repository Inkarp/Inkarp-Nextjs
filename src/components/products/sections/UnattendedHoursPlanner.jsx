...
export default function UnattendedHoursPlanner({ data, productName }) {
  ...
  return (
    <section id={data?.sectionId ?? 'cost-recovery'} className="scroll-mt-16 border-b border-line-light bg-parchment-alt px-4 py-16 sm:px-6 lg:flex lg:min-h-screen lg:flex-col lg:justify-center lg:px-8">
