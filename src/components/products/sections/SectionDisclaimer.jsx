...
export default function SectionDisclaimer({ children, className = '' }) {
  ...
  return (
    <div
      className={`relative mt-6 rounded-2xl border border-line-light bg-parchment-alt px-5 py-4 text-xs leading-6 text-red dark:border-zinc-800 dark:bg-zinc-900 ${className}`}
    >
