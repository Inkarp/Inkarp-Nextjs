...
export default function ApplicationsExplorer({ data }) {
  ...
  return (
    <section id="industries" className="scroll-mt-16 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 px-4 py-16 sm:px-6 lg:px-8">
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="relative mt-6 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8 lg:grid lg:grid-cols-[1fr_464px] lg:gap-12 dark:border-zinc-800 dark:bg-zinc-900">
          <div>
            <h3 className="font-maxot text-2xl font-bold text-black dark:text-zinc-100">{getTabLabel(industry)}</h3>
