...
export default function MethodComparison({ data }) {
  ...
  return (
    <section id="comparison" className="scroll-mt-16 border-b border-line-light bg-[#F6F6F6] px-4 py-16 sm:px-6 lg:px-8 dark:border-zinc-800 dark:bg-zinc-950">
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="relative mt-9 overflow-hidden rounded-2xl border border-line-light bg-parchment shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
          <div className="overflow-x-auto">
            <table className="w-full min-w-[820px] border-collapse">
              <thead>
                <tr className="border-b border-line-light dark:border-zinc-800">
              ...
              <tbody>
                {rows.map((row) => (
                  <tr className="border-b border-line-light last:border-b-0 dark:border-zinc-800" key={row.feature}>
