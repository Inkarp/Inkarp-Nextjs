...
export default function ServiceMap({ data }) {
  ...
  return (
    <section id="service" className="scroll-mt-16 border-b border-line-light bg-[#F6F6F6] px-4 py-14 sm:px-6 lg:px-8 dark:border-zinc-800 dark:bg-zinc-950">
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_1fr]">
          ...
          <div className="relative aspect-square w-full overflow-hidden rounded-2xl border border-line-light bg-parchment shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
          ...
          <div className="flex flex-col gap-4">
            <div className="rounded-2xl border border-line-light bg-parchment p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <div className="rounded-2xl border-2 border-red/30 bg-parchment p-5 shadow-sm dark:bg-zinc-900">
                ...
                <div className="flex flex-col gap-1">
                  {selectedBranch.phone.split(',').map((phone, phoneIndex) => (
                    <a
                      ...
                      className="text-xs font-medium text-black underline hover:text-red dark:text-zinc-100"
                    >
                      {phone.trim()}
                    </a>
                  ))}
