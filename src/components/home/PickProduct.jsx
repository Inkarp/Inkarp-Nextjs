    ...
    <section className="relative h-[100svh] overflow-hidden bg-[#fff3f4] px-3 py-3 sm:px-6 sm:py-5 lg:px-8 lg:py-6 dark:bg-zinc-950">
      ...
      <div className="relative mx-auto flex h-full w-full max-w-7xl flex-col">
        ...
        <div className="mx-auto mb-2 flex shrink-0 max-w-3xl flex-col items-center gap-1.5 text-center sm:mb-3 lg:mb-4">
          <span className="rounded-full border border-[#BE0010]/20 bg-white px-4 py-1 text-xs font-semibold uppercase tracking-wide text-[#BE0010] dark:bg-zinc-900">
            Precision Picks
          </span>
          ...
          <p className="hidden max-w-2xl text-sm leading-6 text-zinc-600 sm:block sm:text-base dark:text-zinc-400">
        ...
        {/* Spotlight panel */}
        <div className="relative min-h-0 flex-1 overflow-visible rounded-2xl border border-[#BE0010]/10 bg-white/90 p-3 shadow-2xl shadow-[#BE0010]/10 backdrop-blur sm:rounded-3xl sm:p-5 lg:overflow-hidden lg:p-8 dark:bg-zinc-900/90">
          <span
            aria-hidden="true"
          ...
          <div className="relative grid h-full min-h-0 grid-rows-[auto_minmax(0,1fr)] items-center gap-2 sm:gap-4 lg:grid-cols-[1.05fr_0.95fr] lg:grid-rows-1 lg:gap-8">
            ...
            <div className="min-h-0">
              <span className="inline-flex items-center gap-2 rounded-full border border-[#BE0010]/15 bg-[#BE0010]/5 px-3 py-1 text-xs font-semibold text-zinc-600 dark:text-zinc-400">
                Featured Solution
              ...
              <p className="mt-2 max-w-md text-xs leading-5 text-zinc-600 sm:mt-3 sm:text-sm sm:leading-6 dark:text-zinc-400">
              ...
              <div className="mt-3 hidden grid-cols-2 gap-3 text-sm sm:grid sm:max-w-sm lg:mt-6">
                <div className="rounded-lg border border-[#BE0010]/10 bg-[#BE0010]/5 p-3">
                  <p className="text-zinc-500 dark:text-zinc-400">Focus</p>
              ...
              <div className="mt-3 flex items-center gap-2 sm:mt-5 lg:mt-7">
                <button
                  ...
                  className="inline-flex size-11 shrink-0 items-center justify-center rounded-full border border-[#BE0010]/20 bg-white text-[#BE0010] transition hover:border-[#BE0010]/40 hover:bg-[#BE0010]/5 dark:bg-zinc-900"
            ...
            <div className="relative flex h-full min-h-0 items-center justify-center">
              ...
              <div className="absolute bottom-1 left-1 flex items-center gap-2 rounded-full border border-[#BE0010]/10 bg-white/85 px-2.5 py-1.5 text-[11px] font-semibold text-zinc-700 shadow-sm backdrop-blur sm:bottom-2 sm:left-2 sm:px-3 sm:py-2 sm:text-xs dark:bg-zinc-900/85 dark:text-zinc-300">
                <FiCheckCircle className="text-[#BE0010]" />
                Curated by specialists
              </div>

              <div className="absolute -right-2 -top-2 size-24 overflow-hidden rounded-full border-2 border-[#BE0010] bg-white shadow-lg shadow-[#BE0010]/30 sm:-right-3 sm:-top-3 sm:size-36 lg:-right-4 lg:-top-4 lg:size-40 dark:bg-zinc-900">
                <Image
                  alt="Dr Dexter"
          ...
          {productOptions.map((item, index) => {
            ...
            return (
              <button
                ...
                aria-pressed={active}
                className={`relative shrink-0 overflow-hidden rounded-2xl border-2 bg-white transition-all duration-300 dark:bg-zinc-900 ${
                  active
